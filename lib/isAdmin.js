// isAdmin.js
const { getGroupMetadataCached } = require('./groupMetadataCache');

async function isAdmin(sock, chatId, senderId) {
    try {
        // 🔧 FIX: use cached groupMetadata instead of calling WhatsApp directly
        // every time — this was firing alongside isOwnerOrSudo/Antilink on the
        // same message and tripping WhatsApp's rate-overlimit (429) errors.
