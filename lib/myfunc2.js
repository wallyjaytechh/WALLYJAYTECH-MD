// lib/myfunc2.js - CommonJS version
...
const buffergif = async (image) => {
    ...
    const trashDir = './XeonMedia/trash/';
    ...
    var buffer5 = await fs.readFileSync(`${trashDir}${filename}.mp4`);
    Promise.all([unlink(`${trashDir}${filename}.mp4`), unlink(`${trashDir}${filename}.gif`)]);
    return buffer5;
};
