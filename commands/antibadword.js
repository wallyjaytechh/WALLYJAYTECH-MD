...
switch (command) {
case 'on':
await enableAntibadword(sock, chatId, message, senderId, isSenderAdmin);
break;
case 'off':
await disableAntibadword(sock, chatId, message, senderId, isSenderAdmin);
break;
case 'add':
await addBadWord(sock, chatId, message, args.slice(1), senderId, isSenderAdmin);
break;
case 'remove':
await removeBadWord(sock, chatId, message, args.slice(1), senderId, isSenderAdmin);
break;
case 'list':
await listBadWords(sock, chatId, message, senderId, isSenderAdmin);
break;
case 'clear':
await clearBadWords(sock, chatId, message, senderId, isSenderAdmin);
break;
case 'status':
...
async function enableAntibadword(sock, chatId, message, senderId, isSenderAdmin) {
if (!isSenderAdmin && !message.key.fromMe) {
await sock.sendMessage(chatId, {
text: '*❌ Only group admins can enable antibadword.*',
contextInfo: {
forwardingScore: 1,
isForwarded: true,
forwardedNewsletterMessageInfo: {
...
async function disableAntibadword(sock, chatId, message, senderId, isSenderAdmin) {
if (!isSenderAdmin && !message.key.fromMe) {
await sock.sendMessage(chatId, {
text: '*❌ Only group admins can disable antibadword.*',
contextInfo: {
forwardingScore: 1,
isForwarded: true,
forwardedNewsletterMessageInfo: {
...
async function addBadWord(sock, chatId, message, words, senderId, isSenderAdmin) {
if (!isSenderAdmin && !message.key.fromMe) {
await sock.sendMessage(chatId, {
text: '*❌ Only group admins can add bad words.*',
contextInfo: {
forwardingScore: 1,
isForwarded: true,
forwardedNewsletterMessageInfo: {
...
async function removeBadWord(sock, chatId, message, words, senderId, isSenderAdmin) {
if (!isSenderAdmin && !message.key.fromMe) {
await sock.sendMessage(chatId, {
text: '*❌ Only group admins can remove bad words.*',
contextInfo: {
forwardingScore: 1,
isForwarded: true,
forwardedNewsletterMessageInfo: {
...
async function listBadWords(sock, chatId, message, senderId, isSenderAdmin) {
if (!isSenderAdmin && !message.key.fromMe) {
await sock.sendMessage(chatId, {
text: '*❌ Only group admins can view the bad words list.*',
contextInfo: {
forwardingScore: 1,
isForwarded: true,
forwardedNewsletterMessageInfo: {
...
async function clearBadWords(sock, chatId, message, senderId, isSenderAdmin) {
if (!isSenderAdmin && !message.key.fromMe) {
await sock.sendMessage(chatId, {
text: '*❌ Only group admins can clear bad words.*',
contextInfo: {
forwardingScore: 1,
isForwarded: true,
forwardedNewsletterMessageInfo: {
